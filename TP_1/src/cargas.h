...
/// encuentra fuera del mismo, y vuelve a solicitarlo. Se utiliza en la opcion del menu ylos kilometros.
///
...
/// @brief La funcion pide el precio al usuario de un rango minimo y maximo,
/// valida el rango y muestra un mensaje de error si el numero ingresado se
/// encuentra fuera del mismo, y vuelve a solicitarlo. Se utiliza solicitar el precio de cada Aerolinea
///
/// @param pPrecio se pasa a que direccion de memoria debe escribir el valor del precio ingresado si finaliza con exito.
/// @param mensaje ide el numero al usuario, se carga en la llamada.
/// @param error Muestra el mensaje de numero incorrecto, se carga en la llamada.
/// @param minimo precio minimo que puede ingresar.
/// @param maximo precio maximo que puede ingresar.
/// @param reintentos  se brinda la cantidad de reintentos que puede hacer la carga y se van descontando.
/// @return retorna 0 si la funcion finaliza con exito y -1 si no se pudo obtener el precio.
